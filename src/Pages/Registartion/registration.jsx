      ...
      <form>
        ...
        <div className="row">
          <div className="col-md-6 col-sm-6 col-4 btns">
            <span
              className={isPerson ? "type-btn active" : "type-btn"}
        ...
        <div className="inputs">
          <div>
            <input type="text" className="input" placeholder="Անուն *" />
          </div>
          <div>
          ...
          <div className="radios">
            <div className="experiance">
              ...
              <label htmlFor="1" className="exp-year">
                <input type="radio" id="1" name="exper" value="Մինչև 1տ" />{" "}
                Մինչև 1տ.
              </label>
              <label htmlFor="3" className="exp-year">
                <input type="radio" id="3" name="exper" value="1-3տ" /> 1-3տ.
              </label>
              <label htmlFor="5" className="exp-year">
                <input type="radio" id="5" name="exper" value="3-5տ" /> 3-5տ.
              </label>
              <label htmlFor="6" className="exp-year">
                <input type="radio" id="6" name="exper" value="5 և ավել տ" /> 5
                և ավել տ.
              </label>
            </div>
            {isPerson && (
          ...
          <div className="select">
            <Form.Select
              ...
              defaultValue={"Երկիր"}
            >
              <option disabled hidden value={"Երկիր"}>
                Երկիր
              </option>
            ...
            <Form.Select
              aria-label="Default select example"
              className="input"
              defaultValue={"Քաղաք / մարզ"}
            >
              <option disabled hidden value={"Քաղաք / մարզ"}>
                Քաղաք / մարզ
              </option>
          ...
          <div className="d-flex align-items-start my-3">
            ...
            <label htmlFor="agree" className="agree">
              <Link to="/frontend/rules">
                Համաձայն եմ հայտարարությունների հրապարակման կանոններին, նաև
                Kadr.am կայքի օգտագործման համաձայնագրին:
              </Link>
            </label>
          </div>
        </div>
        ...
        <p className="have-profile">
          Ունե՞ք անձնական էջ | <Link to="/frontend/login">Մուտք</Link>
        </p>
      </form>
    </div>
  );

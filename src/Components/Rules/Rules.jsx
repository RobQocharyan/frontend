  ...
  return (
    <div className="rules" id="one">
      ...
      <main className="rules__section"  >
        <h1>Օգտագործման համաձայնագիր</h1>
        ...
        <div className="rules__agreement" id="rulesone" >
          ...
          <p>
            ...
            բացատրությունների,<span id="two"></span> հեռացնել տեղադրված նյութը` օգտատերերի կողմից
        ...
        <div>
          ...
          <ol>
            ...
            <li>
              ...
              աշխատանքի<span id="thre"></span> հետ կապված իր դժգոհությունները հղել հետադարձ կապի
        ...
        <div>
          <h2>Պատասխանատվության սահմանափակումը</h2>
          ...
          <p>
            ...
            որ բոլոր անսարքությունները անմիջապես կվերացվեն: Մենք չե՛նք<span  id="four"></span>կարող
        ...
        <div>
          ...
          <p>
            ...
            նպատակի ետևից՝<span  id="five"  ></span> համոզված, որ մի օր կդառնանք շուկայում առաջատար
